...
| Cenrādis | Cilne **Vispārīgi** un lapas **Ātrā izveide** | Iestatiet izmaksu likmi lomai, uzņēmumam, kas nodrošina resursus, un vienību kombinācijai, kas nodrošina resursus. Piemēram, izstrādātājs no Fabrikam India maksā 1000 INR vai izstrādātājs no Fabrikam USA maksā 150 USD. | Cena ir izmaksu likme, kas pēc noklusējuma attiecas uz ienākošā novērtējuma vai faktiskās rindas vienības izmaksām darbības klasē **Laiks**. |
