...
## <a name="create-an-estimate-directly-on-a-projectbased-contract-line"></a>Aprēķinu izveide tieši projekta līguma rindā
...
| **Resursu uzņēmums** | **Ātrā izveide** | Resursu uzņēmums vai juridiska persona, kas veido šīs izmaksas un nodrošina resursam darbu ar to. | Šis lauks pēc noklusējuma ir izveidots ar to saistīto līguma rindu informāciju, kas attiecas uz automātiski izveidotajām izmaksām. Šo lauku izmanto arī izmaksu izgūšanai. |
