...
description: Šajā rakstā ir informācija par tiem laukiem, kas ietekmē līguma rindas, un informācija par līgumu, kas tiek apkopota visiem rindas vienumiem.
author: rumant
ms.date: 10/20/2020
ms.topic: article
...
ms.locfileid: "8921587"
---
# <a name="header-details-for-project-based-contracts"></a>Projektu līgumu virsraksta informācija
...
| Reģistrētais daudzums | Projekta rindas detalizētā informācija | Laiks: viss laika daudzums laika izmaksu faktiskajiem datiem lomai projektā, kas ir kartēta šajā līguma rindā. Izmaksas: visi šīs izdevumu kategorijas daudzumi uz projekta izdevumu izmaksu aktuāļiem ir kartēti uz šo līguma rindu. |
