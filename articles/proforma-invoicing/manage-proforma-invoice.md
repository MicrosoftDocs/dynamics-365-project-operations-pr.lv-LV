...
| **Resursu uzņēmums** | Pēc noklusējuma iestatīts no avota faktiskajām vērtībām. Tikai lasāms lauks, kura rediģēšana ir bloķēta. | Lauku var rediģēt jaunā rēķina rindas informācijā, kas nebalstās uz avota faktiskajām vērtībām. |
