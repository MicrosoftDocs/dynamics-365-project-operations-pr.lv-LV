...
- **\<EntitiesToEnableScheduling\>** nosaka, kuras entītijas ir jāiespējo rezervēšanai Microsoft Dynamics plānošanai (sauktai arī par Universal Resource Scheduling).
