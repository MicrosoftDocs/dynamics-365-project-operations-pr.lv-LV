...
## <a name="using-journals-to-record-costs"></a>Žurnālu izmantošana izmaksu reģistrēšanai

Programmā PSA žurnāli ļauj ierakstīt izmaksas vai ieņēmumus materiālu, maksu, laika, izdevumu vai nodokļu transakciju klasēs. Žurnālā ir virsraksts, rindas un darbība **Apstiprināt**. Piedāvājam dažus scenārijus, kuros jūs varētu izmantot žurnālu.
